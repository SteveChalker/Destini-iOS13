...
struct StoryBrain {
    ...
    mutating func choiceMade(_ choice: String) -> Story {
        if(choice == currentStory.choice1) {
            currentStory = adventure[currentStory.choice1Destination]
        } else {
            currentStory = adventure[currentStory.choice2Destination]
        }
